...
const Contact = ()=>{
    return <motion.div layout id="contact" className="py-[6rem] bg-white text-black flex flex-col items-center gap-2">
        <motion.div layout  viewport={{ once: true }} initial={{ opacity: 0 , translateY : 100 }} whileInView={{ opacity: 1 , translateY : 0  } } transition={{ duration : 0.35  }} className="icon text-black"><TbMessageCircle2 className="text-[3.5rem]"/></motion.div>
